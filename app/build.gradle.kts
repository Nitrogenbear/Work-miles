...
android {
    namespace = "uk.co.mheonsitetraining.miles"
    compileSdk = 35

    defaultConfig {
        applicationId = "uk.co.mheonsitetraining.miles"
        minSdk = 29
        targetSdk = 35
        versionCode = 2
        versionName = "1.1"
    ...
    lint {
        // Lint still runs via ./gradlew lint; don't let it block building the APK.
...
dependencies {
    implementation("uk.co.mheonsitetraining.miles:core:1.0")
